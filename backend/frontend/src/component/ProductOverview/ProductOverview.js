...
export default function ProductOverview() {
  ...
  const [isitemFetched, setItemFetched] = useState(false);
    ...
    <>
      {isitemFetched ? (
              ...
              <div className="ml-2 mt-4 lg:row-span-3 lg:mt-0">
                ...
                <div className="py-10 border-b border-gray-200 pb-16 pr-8 pt-6">
                  ...
                  <div>
                    ...
                    {/* price */}
                    <div className="flex">
                      <p className="text-3xl my-3 mr-5 font-semibold tracking-tight text-gray-900">
                        ₹{item.selling_price}
                      </p>
                      <p className="text-xl mr-3 line-through my-auto tracking-tight text-gray-500">
                        ₹{item.price}
                      </p>
                      <p className="text-xl my-auto tracking-tight font-semibold text-green-500">
                        {Math.round(
                          100 - (item.selling_price / item.price) * 100
                        )}
                        % off
                      </p>
                    </div>
        ...
        <div className="bg-white mx-3 mb-3 rounded-sm">
          <div className="mx-auto flex flex-col md:flex-row md:justify-center lg:justify-center mt-6 p-6 shadow-md">
            {/* Image gallery */}
            <div className="bg-slate-200 aspect-h-5 aspect-w-4 lg:aspect-h-4 h-[45vh] md:h-[50vh] lg:h-[60vh] xl:h-[70vh] w-[75vw] md:w-[50vw] lg:w-[40vw] xl:w-[30vw] mx-auto md:mx-10 lg:mx-20 shadow-md">
            </div>

            {/* title, description of product */}
            <div className="sm:rounded-lg">
              <div className="ml-2 mt-4 lg:row-span-3 lg:mt-0">
                <div className=" bg-slate-300 w-[120px] h-[50px] sm:w-[400px]">
                </div>

                <div className="py-10 border-b border-gray-200 pb-16 pr-8 pt-6">
                  {/* Description and details */}
                  <div>
                    <div className=" bg-slate-200 w-[800px] h-[20px] mb-12">
                    </div>

                    {/* price */}
                    <div className="flex">
                      <div className=" bg-slate-200 w-[200px] h-[20px]">
                      </div>
                      <div className=" bg-slate-200 w-[200px] h-[20px]">
                    </div>
                    <div className=" bg-slate-200 w-[200px] h-[20px]">
                  ...
                  <div className="mt-6">
                    <div className="mt-4">
                      <ul className="list-disc space-y-2 pl-4 text-sm">
                        {[1,1,1,1].map((highlight,i) => (
                          <li key={i} className="bg-white-400">
                            <div className="bg-gray-300 w-[200px] h-[10px]"></div>
                          </li>
                        ))}
                      </ul>
                    </div>
