...
function Overview() {
  ...
  const fetch = async () => {
    const response = await axios.get(
      `${window.location.origin}/api/admin/noofproduct`,
  ...
  const fetch2 = async () => {
    const response = await axios.get(
      `${window.location.origin}/api/admin/pending&successProduct`,
      { withCredentials: true }
    );
    if (response.data.success) {
  ...
  const handConfirm = async (e) => {
    //API call
    try {
      const response = await axios.put(`${window.location.origin}/api/admin/confirmOrder`,
      e,
      {withCredentials:true})
  ...
  const handReject = async (e) => {
    //API call
    try {
      const response = await axios.put(`${window.location.origin}/api/admin/rejectOrder`,
      e,
      {withCredentials:true})
